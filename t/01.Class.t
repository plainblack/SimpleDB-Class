...
like($request->content, qr/^AWSAccessKeyId=accessyy&Action=DoSomething&Timestamp=\d{4}-\d{2}-\d{2}T\d{2}%3A\d{2}%3A\d{2}\.000Z&Version=2009-04-15&foo=bar&Signature=[A-Za-z0-9]+%3D$/, "request document looks good");
